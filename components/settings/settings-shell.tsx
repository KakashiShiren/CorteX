...
import { CanvasSettingsSection } from "@/components/canvas/canvas-settings-section";
    ...
    <AppShell>
      <div className="space-y-6">
        <div>
          ...
          <h1 className="page-title mt-3">Personalize Grove</h1>
        ...
        <div className="grid gap-6 xl:grid-cols-[280px_minmax(0,1fr)]">
          ...
          {activeTab === "/settings/canvas" ? <CanvasSettingsSection /> : null}
